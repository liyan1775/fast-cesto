...
export const translations = Object.freeze({
  en: {
    ...
    "activity.detectedOriginal": "Detected the supported Epic 1.01.3 original archive.",
    ...
    "preflight.detail.archiveOriginal": "Recognized the Epic 1.01.3 original archive.",
    "preflight.detail.archiveMod": "Recognized a registered Epic 1.01.3 Fast Cesto archive.",
  ...
  "zh-CN": {
    ...
    "activity.detectedOriginal": "检测到受支持的 Epic 1.01.3 原版归档。",
    ...
    "preflight.detail.archiveOriginal": "已识别 Epic 1.01.3 原版归档。",
    "preflight.detail.archiveMod": "已识别登记过的 Epic 1.01.3 Fast Cesto 归档。",

...
> 2026-08-11 状态：Epic `1.01.3` 配置化本地补丁器、本地双语 UI、脱敏诊断和 `v0.1.0-alpha.2` 已完成，通过公开 GitHub Alpha 招募网络测试者；尚未经过跨机验证，不达到公开 Beta 门槛。完整 `assets.dat` 仅为本地测试产物，任何发布均不得包含游戏资源。

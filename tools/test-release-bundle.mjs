...
const directory = join(root, "dist", "fast-cesto-v0.2.0-alpha.1");
...
for (const required of ["start-fast-cesto.cmd", "release-manifest.json", "README.md", "PRIVACY.md", "KNOWN-ISSUES.md", "i18n.js", "fast-cesto.focus-preview.json"]) {
...
requireEqual(manifest.version, "0.2.0-alpha.1", "manifest version");

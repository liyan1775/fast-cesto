# Known issues — v0.1.0-alpha.2 / 已知问题

- Only the exact registered Epic Games Store Windows `1.01.3` hash is supported.
...
简要说明：当前只支持 Epic Windows `1.01.3` 精确哈希，要求 Node.js 20+；Turbo 暂停/切场景、特殊金币分支、Windows 10、非 ASCII 路径、高 DPI、第三方安全软件和更多权限环境仍需外部测试。
